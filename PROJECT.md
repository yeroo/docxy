...
and deleting the bracket resets it to 100%. An existing resource whose name
matches the whole token wins; otherwise a name ending in `[...]` must hold valid
`NN%` units. Retained assignments whose text is unchanged keep their units/work.
