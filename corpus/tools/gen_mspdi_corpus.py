...
def build():
    ...
    rich_res = (
        ...
        "<IsGeneric>1</IsGeneric><IsInactive>0</IsInactive><IsEnterprise>1</IsEnterprise>"
    ...
    rich_asn = ("    <Assignment><UID>1</UID><GUID>5D6E7F80-9A1B-4C2D-8E3F-405162738495</GUID>"
                ...
                f"<RemainingWork>PT16H0M0S</RemainingWork><ResponsePending>1</ResponsePending>"
                f"<Start>{dt(2)}</Start>"
                ...
                "<BCWS>225</BCWS><BCWP>202.5</BCWP><BookingType>1</BookingType>"
                ...
                "<AssnOwnerGuid>2D906E4C-3F51-4A7C-8D8E-9FA0B1C2D3E4</AssnOwnerGuid>"
                ...
                "</TimephasedData>"
                f"<TimephasedData><Type>2</Type><UID>1</UID><Start>{dt(2)}</Start>"
                f"<Finish>{dt(3)}</Finish><Unit>2</Unit><Value>PT3H0M0S</Value></TimephasedData>"
                f"<TimephasedData><Type>4</Type><UID>1</UID><Start>{dt(2)}</Start>"
                f"<Finish>{dt(3, '17:00:00')}</Finish><Unit>2</Unit><Value>PT16H0M0S</Value>"
                "</TimephasedData>"
                "</Assignment>")
